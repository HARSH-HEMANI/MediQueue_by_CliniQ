        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="./doctor.php">Doctor/Hospital</a></li>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="navbar-nav mb-2 px-5 text-lg-center">
                <a href="./doctor.php" type="none" class="nav-link">Appointments</a>
            </div>
            ...
            <div class="navbar-nav mb-2 px-5 text-lg-center">
                <a href="./doctor.php" type="none" class="nav-link">Patient Records</a>
            </div>

            <div class="navbar-nav mb-2 px-5 text-lg-center">
                <a href="./doctor.php" type="none" class="nav-link">Consultation Time Analytics</a>
            </div>
