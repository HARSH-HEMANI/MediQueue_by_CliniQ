        ...
        <section class="mb-4">
            <div class="dcard text-center p-4 current-token-card">
                ...
                <div class="mb-2">
                    ...
                    <?php if ($currentType): ?>
                        <span class="badge ms-1 <?php echo ($currentType === 'Emergency') ? 'type-emergency' : 'type-follow'; ?>">
                ...
                <div class="current-token-number">
                    <?php echo $currentToken ? "Token #" . htmlspecialchars($currentToken) : "No Active Token"; ?>
                </div>

                <div class="patient-name mt-2">
                    <?php
                    if ($currentName) {
                        echo htmlspecialchars($currentName) . " (" . (int)$currentAge . " yrs)";
                    } else {
                        ...
                        <table class="table mb-0 queue-table">
                            ...
                            <tbody>
                                ...
                                <tr class="priority-row">
                                    ...
                                    <td>
                                        <a href="?state=emergency" class="badge bg-danger text-decoration-none">View</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="dcard">
                    ...
                    <div class="card-body">
                        <?php if ($currentName): ?>
                            ...
                            <p class="mb-1"><strong>Age:</strong> <?php echo (int)$currentAge; ?></p>
