...
$email = $_SESSION['doc_verify_email'];
$name  = $_SESSION['doc_verify_name'] ?? 'Doctor';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Verify OTP | MediQueue Doctor</title>
...
<body>
    ...
    <div class="card">
        ...
        <?php if (isset($_SESSION['doc_otp_error'])): ?>
            <div class="error-msg"><?php echo $_SESSION['doc_otp_error'];
                                    unset($_SESSION['doc_otp_error']); ?></div>
        <?php endif; ?>
